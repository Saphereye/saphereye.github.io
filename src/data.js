...
export const academichonors = [
  {
    "title": "Research Internship at NCPOR, Goa",
    "body": "Secured a research internship at the National Centre for Polar and Ocean Research, Goa, and developed a website for the submission of research proposals and data analysis. The project was made using Django and React and was well received by the institute."
  },
  {
    "title": "HERE Hackathon 2023",
    "body": "The hackathon comprised of many teams and various topics to choose from. Our team chose to create a quick emergency services calling app called ServiQuick and came third in the competition."
  },
  {
    "title": "German Declamation Contest Champion (Goethe Institute)",
    "body": "Secured second place in the prestigious German declamation contest organized by the Goethe Institute, Delhi."
  },
  {
    "title": "Goethe Institute German Language Proficiency Certification",
    "body": "Earned a B2 proficiency certification in the German language from the Goethe Institute, Delhi, demonstrating advanced fluency and comprehension."
  },
  {
    "title": "Prayag Sangeet Samiti Master's Degree in Classical Music",
    "body": "Received a Master's degree in classical music from the esteemed Prayag Sangeet Samiti, Allahabad, with a focus on synthesizers. Additionally, I possess knowledge of playing the sitar."
  },
  {
    "title": "SAT Score Achievement",
    "body": "Achieved a remarkable SAT score of  1410 out of  1600, and  2350 out of  2400 in the SAT subject test, reflecting strong analytical and critical thinking abilities."
  },
  {
    "title": "CBSE Board Examinations",
    "body": "Graduated with high honors from Amity International School, Noida, securing  98.2% in  10th grade and  94.6% in  12th grade under the CBSE board system. Awarded prestigious medals for achieving  100% in Mathematics and Social Science in  10th grade."
  },
]